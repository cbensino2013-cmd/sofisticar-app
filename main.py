...
def enviar_sms_confirmacao(numero_destino: str, nome_cliente: str, data: str, hora: str):
    ...
    if not (TWILIO_ACCOUNT_SID and TWILIO_AUTH_TOKEN and TWILIO_PHONE_NUMBER):
        print("⚠️ Credenciais do Twilio não configuradas nas variáveis de ambiente.")
        return
    ...
    try:
        ...
        mensagem = (
            f"Ola {nome_cliente}! O seu agendamento no Centro Auto Sofisticar "
...
# 🔄 ALTERAR ESTADO DO AGENDAMENTO E ENVIAR SMS
